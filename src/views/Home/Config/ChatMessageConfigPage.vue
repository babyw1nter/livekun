    ...
    <a-row :gutter="[16, 16]">
      <a-col :sm="24" :lg="14" :xl="16">
        <a-space direction="vertical" size="middle" style="width: 100%;">
          ...
          <a-card>
            <a-space direction="vertical" style="width: 100%;">
              <a-typography-text strong>业务、身份图标显示 <a-tag color="orange">未完成</a-tag></a-typography-text>
          ...
          <a-card>
            <a-space direction="vertical" style="width: 100%;">
              <a-typography-text strong>事件消息显示 <a-tag color="orange">未完成</a-tag></a-typography-text>
                ...
                <a-row :gutter="24" style="margin: 0;">
                  <a-col :xs="24">
                    <a-form-item label="事件类型">
                      <a-checkbox-group>
                        <a-checkbox
                          v-model:checked="chatMessagePluginConfig.reactivityPluginConfig.pluginConfig.event.join"
                        ...
                        <a-checkbox
                          v-model:checked="chatMessagePluginConfig.reactivityPluginConfig.pluginConfig.event.gift"
...
onMounted(() => autoPreviewSwitchChange())
